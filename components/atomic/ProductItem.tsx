...
const ProductItem = ({ product }: { product: Product }) => {
  ...
  return (
    <tr key={id} className="bg-white border-b even:bg-slate-100">
      <td className="py-2 text-center border-r">{id}</td>
      <td className="px-6 py-2 font-medium text-gray-900 border-r">{name}</td>
      <td className="px-6 py-2 font-medium text-gray-900 border-r">{price}</td>
      <td className="flex justify-center gap-4 px-1 py-2 text-center">
